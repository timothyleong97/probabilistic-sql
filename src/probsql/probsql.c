...
Oid gate_oid()
{
    ...
    // Can confirm result with pg_type table
...
//         elog_node_display(INFO, "Create statement", stmt, true);
//         ListCell *lc;
...
//                 // Ref: https://doxygen.postgresql.org/createas_8c_source.html#l00158
//                 ColumnDef *condition_columndef = makeColumnDef("cond", gate_oid(), -1, 0);
//                 // Make TRUE the default value for the condition column
//                 Constraint
//                 stmt->tableElts = lappend(stmt->tableElts, condition_columndef);
//                 return;
//             }
//         }
//     }
...
//                 {
//                     // Insert the condition column as a new TargetEntry
//                 }
//             }
...
//                 ereport(INFO, errmsg("Unrecognised node tag in handle_create_table_with_gate: %u", nodeTag(expr)));
//             }
//         }
//     }
// }
...
static bool is_select_from_table_with_gate_in_condition(Query *query)
{
    ...
    // ref: https://doxygen.postgresql.org/subselect_8c_source.html#l01696
    ...
    foreach (lc, (List *)whereClause)
    {
        ...
        // TODO Check if either the left or right hand side is an
        // attribute from the table with the gate type
    }
}
...
{
    ereport(INFO, errmsg("Inside prob_planner"));
                                   ...
                                   DestReceiver *dest, QueryCompletion *qc)
{
    /*
        ...
        // TODO use a manual cond inserter and remover as an escape hatch
    */
